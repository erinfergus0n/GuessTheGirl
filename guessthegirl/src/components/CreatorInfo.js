...
const Creators = () => {
  ...
  const creatorDetails = [
    ...
    { name: "Joanna", country: "Northern Ireland", topArtist: "Rihanna", favouriteHobby: "Horse riding", starsign: "Taurus", funFact: "I have 2 horses and 2 dogs." },
    { name: "Laura", country: "Scotland", topArtist: "Chappell Roan", favouriteHobby: "Swimming", starsign: "Capricorn", funFact: "I have 104 vinyl records." }
  ];
